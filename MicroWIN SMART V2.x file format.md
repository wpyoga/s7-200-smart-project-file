  ...
  - CPU information block
    - contents
      ...
      - 7 bytes CPU firmware version
        - 03 01 00 0d 00 00 00 for V03.01.00\_13.00.00.00 ??? ST32 first release
        ...
        - 01 00 00 08 37 00 00 for V01.00.00\_08.37.00.00 ??? found in template
...
- if not present: 8 bytes null or garbage data
  - sometimes the first 4 bytes are:
    - 2 bytes unknown: 82 a6
    - 1 byte unknown: a3 or 4b
    - 1 byte unknown: 54 or 66
  - sometimes also: d0 05 d8 01
  - sometimes also: 78 56 f9 04
  - the first 4 bytes seem to be the signal board identifier
  - the other 4 bytes seem to be the presence indicator
- if SB DT04
  - 4 bytes: 00 20 00 80
  - 4 bytes: 01 00 00 00
...
- if no expansion module
  - 8 bytes null or garbage data: 4c 60 cd 67 00 00 00 00
- if DP01: 293 bytes
  - 4 bytes: 01 40 00 80
  - 4 bytes: 01 00 00 00
  - 1 byte: 06
